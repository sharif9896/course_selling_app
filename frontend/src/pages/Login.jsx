...
//       if (user) {
//           dispatch(AuthAction.addtrue(true));
//       } else {
//           dispatch(AuthAction.addtrue(false));
//       }
//     }, []);
  ...
  return (
    <div className="bg-gradient-to-r from-black to-blue-950">
      <div className="h-screen  container mx-auto flex  items-center justify-center text-white">
        {/* Header */}
        <header className="absolute top-0 left-0 flex bg-gradient-to-r from-black to-blue-950 w-[100%] justify-between items-center p-5  ">
          <div className="flex items-center space-x-2">
            <img src="log.png" alt="Logo" className="w-10 h-10 rounded-full" />
